...
// tpexIntermediateCertificate is the intermediate that www.tpex.org.tw omits
// from its TLS handshake. It is published by TWCA at the CA Issuers URL in the
// site's leaf certificate and is valid until 2033-02-23.
const tpexIntermediateCertificate = `-----BEGIN CERTIFICATE-----
